...
[![Total Ideas](https://img.shields.io/badge/Total_Ideas-304-blue)](#)
...
모든 아이디어는 **GitHub + Vercel 배포 가능**, **무료 기술 스택 기준**, **기존 저장소와 중복 없음**을 원칙으로 합니다. 현재 **11개 카테고리, 304개 아이디어**가 수록되어 있습니다.
...
2. **[IDEA_INDEX.md](IDEA_INDEX.md)** — 전체 304개 아이디어 마스터 인덱스
3. **[EXISTING_REPOS.md](EXISTING_REPOS.md)** — sigco3111 전체 141개 저장소 목록

**아이디어 생성 파이프라인:**
1. 에이전트에게 `IDEA_GENERATION_GUIDE.md` 제공 (Section A: 141개 기존 저장소 + Section B: 304개 기존 아이디어 + 형식 템플릿 + 규칙 모두 포함)
2. 아이디어 초안 생성
...
| 3D 글로브 | 웹 게임 | 데이터 시각화 | AI 에이전트 | 교육 | 오디오 | 아트 | 생산성 | 과학 | deck.gl 시각화 | deck.gl 게임 | 총계 |
|:---------:|:-------:|:------------:|:-----------:|:----:|:------:|:----:|:------:|:----:|:-------:|:----:|:----:|
| 49 | 27 | 24 | 27 | 22 | 25 | 25 | 25 | 25 | 25 | 25 | **304** |
