...
[![Total Ideas](https://img.shields.io/badge/Total_Ideas-379-blue)](#)
[![Categories](https://img.shields.io/badge/Categories-13-purple)](#)
...
모든 아이디어는 **GitHub + Vercel 배포 가능**(웹) 또는 **macOS CLI/데스크톱 앱**, **무료 기술 스택 기준**, **기존 저장소와 중복 없음**을 원칙으로 합니다. 현재 **13개 카테고리, 379개 아이디어**가 수록되어 있습니다.
...
| 🖥️ [TUI 게임](TUI_Game_Project_Ideas.md) | 터미널 UI 기반 업무 위장형 게임 (htop/vim/gdb/kubectl 외형) | 20 |
...
- 아이디어 형식 템플릿
- 생성 규칙 (한국어, 무료 기술, Vercel 배포 또는 macOS CLI)
...
├── TUI_Game_Project_Ideas.md             # TUI 게임 아이디어 (20개)
```
...
2. **[IDEA_INDEX.md](IDEA_INDEX.md)** — 전체 354개 아이디어 마스터 인덱스
3. **[EXISTING_REPOS.md](EXISTING_REPOS.md)** — sigco3111 전체 141개 저장소 목록

**아이디어 생성 파이프라인:**
1. 에이전트에게 `IDEA_GENERATION_GUIDE.md` 제공 (Section A: 141개 기존 저장소 + Section B: 354개 기존 아이디어 + 형식 템플릿 + 규칙 모두 포함)
2. 아이디어 초안 생성
...
- **비용:** 무료 (오픈소스 + 무료 API + 로컬 실행)
- **배포:** Homebrew, npm global, GitHub Releases
- **언어:** Swift, Rust, Go, TypeScript (Node.js), Python
- **CLI 프레임워크:** Commander (Swift), clap (Rust), Cobra (Go), Commander.js (Node.js), Typer/Click (Python)
- **데스크톱:** SwiftUI, AppKit, Tauri, Electron
- **로컬 데이터:** SQLite, UserDefaults, JSON/YAML 설정 파일
- **시스템 연동:** macOS API, shell 명령, filesystem 접근
...
| 3D 글로브 | 웹 게임 | 데이터 시각화 | AI 에이전트 | 교육 | 오디오 | 아트 | 생산성 | 과학 | deck.gl 시각화 | deck.gl 게임 | 오픈코드 유틸 | Playwright E2E | 총계 |
|:---------:|:-------:|:------------:|:-----------:|:----:|:------:|:----:|:------:|:----:|:-------:|:----:|:----------:|:-------------:|:----:|
| 49 | 27 | 24 | 27 | 22 | 25 | 25 | 25 | 25 | 25 | 25 | 50 | 25 | **379** |
